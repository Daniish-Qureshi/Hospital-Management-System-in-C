...
1. Clone the repository:
   ```bash
   git clone https://github.com/Daniish-Qureshi/Hospital-Management-System-Project-Using-C-Language.git
   ```

2. Navigate to the project directory:
   ```bash
   cd Hospital-Management-System-Project-Using-C-Language
   ```
